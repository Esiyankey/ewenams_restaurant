  ...
  return (
    <nav
      className={` w-full z-50 transition-all duration-300 ${
        scroll ? "bg-[#233100]/95 shadow-md sticky top-0" : "bg-[#233100]"
    ...
    >
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden   left-0 right-0 bg-white shadow-lg rounded-b-lg overflow-hidden transition-all duration-300 max-h-[80vh] overflow-y-auto">
